...
exportgraphics(fH, './proposalFigs/exp.png', 'Resolution', 600);
...
% exportgraphics(fH, './proposalFigs/experiment-data.png', 'Resolution', 600);
...
% exportgraphics(fH, './proposalFigs/recoverd-complex-c.png', 'Resolution', 600);
...
legend('参考BSD', ...
       ['全局优化方法, ', num2str(round(sum(n_ga))), ' 个气泡'], ...
       ['最小二乘方法, ', num2str(round(sum(n_i_lse))), ' 个气泡'], ...
       ['约束最小二乘方法, ', num2str(round(sum(n_i_clse))), ' 个气泡'])

exportgraphics(fH, './proposalFigs/fig_exp-result.png', 'Resolution', 600);